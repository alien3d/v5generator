...
if (isset($data) && is_array($data)) {
    ...
    $str .= "	 * @var \\Core\\Database\\Mssql\\Vendor \n";
    $str .= "	 */ \n";
    $str .= "	public \$q; \n";
    ...
    $str .= "		    \$filterArray = array(\"[" . strtolower($data [0] ['tableName']) . "].[" . $data [0] ['primaryKeyName'] . "]\",\"[staff].[staffPassword]\"); \n";
    ...
    $str .= "                       \"" . $data [0] ['tableName'] . "Code\" => \$row ['" . $data [0] ['tableName'] . "Code'], \n";
    $str .= "                       \"time\"=>\$time)); \n";
    $str .= "           exit(); \n";
    $str .= "       } else { \n";
    $str .= "           \$end = microtime(true); \n";
    ...
    $str .= "         AND       [companyId] =   \" . \$this->getCompanyId(). \" \";\n";
    if (isset($dataDetail) && count($dataDetail) > 0) {
        $str .= " \$sql.=\"AND     [" . $dataDetail[0]['primaryKeyName'] . "] = \".\$this->model->get" . ucfirst($dataDetail[0]['primaryKeyName']) . "().\" \";\n";
    }
